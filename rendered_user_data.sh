# Generated on: 2024-11-05 16:50:56 UTC
# Cluster: demo-cluster-ef4ae95c
# Region: us-east-1
...
export CLUSTER_NAME="demo-cluster-ef4ae95c"
export LOG_GROUP_NAME="log_group-ef4ae95c"
export LOG_STREAM_NAME="ecs"
export REGION="us-east-1"


# Write environment variables to /etc/environment for persistence
echo "CLUSTER_NAME=demo-cluster-ef4ae95c" | sudo tee -a /etc/environment
echo "LOG_GROUP_NAME=log_group-ef4ae95c" | sudo tee -a /etc/environment
...
# ECS_CLUSTER=demo-cluster-ef4ae95c
# ECS_LOGLEVEL=debug
# ECS_AVAILABLE_LOGGING_DRIVERS=["json-file","awslogs"]
# ECS_ENABLE_CONTAINER_METADATA=true
# ECS_ENGINE_TASK_CLEANUP_WAIT_DURATION=1h
